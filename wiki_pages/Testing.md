# CacheCore Testing Suite

This page explains the automated test scripts used to verify that CacheCore works correctly and can actually handle heavy concurrency without crashing or deadlocking. 

## Requirements
- Python 3
- The `CacheCore` binary must be compiled and located in the `build/` directory (the scripts will look for `../build/kv-store`).
